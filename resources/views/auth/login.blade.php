        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="{{asset('image/neraca.jpg')}}"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                <form method="POST" action="{{ route('login') }}" class="form">
                  ...
                  <h5 class="fw-normal mb-3 pb-2" style="letter-spacing: 1px;text-align:center;"><b>Aplikasi Neraca Keuangan</b><br>HKBP Kisaran Kota</h5>
                  ...
                  <span class="small text-muted">Copyright © 2023 | <a href="https://jasabikin.com" target="_blank" class="text-muted"> jasabikin.com</a></span>
                </form>
