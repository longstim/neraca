...
@section('page_heading', 'Daftar Pengeluaran')
@section('breadcrumb')
<a href="{{url('pengeluaran/tambah-pengeluaran')}}" class="btn bg-primary float-right"><i class="fas fa-plus-circle"></i> &nbsp;Tambah Data</a>
@endsection
@section('content')
<style>
  #dropdown-action-id
