...
@section('content')
  <!-- Main content -->
    ...
    <div class="col-md-12">
        <form role="form" id="arsip" method="post" action="{{url('pengeluaran/proses-tambah-pengeluaran')}}">
        {{ csrf_field() }}
          <div class="card">
              <div class="card-body">
                  <div class="form-group col-md-12 row">
                      ...
                      <div class="col-md-4">
                        <div class="input-group date">
                            <input type="text" name="tgl_pengeluaran" id="datepicker" class="form-control" placeholder="dd/mm/yyyy" value="{{date('d/m/Y')}}" required>
                  ...
                  <div class="form-group col-md-12 row">
                    ...
                    <div class="col-md-9">
                          <input type="text" name="jumlah_pengeluaran" class="form-control" id="txtJumlahPengeluaran" required>
                    </div>
                  </div>
                </div>
...
$(document).ready(function () {
  $("#txtJumlahPengeluaran").keyup(function(){
       $("#txtJumlahPengeluaran").val(formatRupiah($(this).val()));
    });
});
