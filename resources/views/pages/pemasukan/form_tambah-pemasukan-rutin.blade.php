...
@section('content')
  <!-- Main content -->
    ...
    <div class="col-md-12">
        <form role="form" id="arsip" method="post" action="{{url('pemasukan/proses-tambah-pemasukan-rutin')}}">
        {{ csrf_field() }}
          <div class="card">
              <div class="card-body">
                  <div class="form-group col-md-12 row">
                      ...
                      <div class="col-md-4">
                        <div class="input-group date">
                            <input type="text" name="tgl_pemasukan" id="datepicker" class="form-control" placeholder="dd/mm/yyyy" value="{{date('d/m/Y')}}" required>
                    ...
                    <div class="col-md-9">
                      <select name="jenis_kegiatan" class="form-control select2bs4" id="jeniskegiatanSlc" style="width: 100%;" required>
                              ...
                              @foreach($jeniskegiatan as $data)
                                  <option value="{{$data->id}}">{{$data->akun}}</option>
                              @endforeach
                          </select>
                      </div>
                  </div>
                  <div class="form-group col-md-12 row">
                    ...
                    <div class="col-md-9">
                          <input type="text" name="jumlah_pemasukan" class="form-control" id="txtJumlahPemasukan" required>
                    </div>
                  </div>
                  <div class="form-group col-md-12 row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                      <div class="input-group">
                          ...
                          <input type="text" name="jumlah huria" class="form-control" id="txtJumlahHuria" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-md-12 row">
                    ...
                    <div class="col-md-9">
                      <div class="input-group">
                          ...
                          <input type="text" name="jumlah_bpsk" class="form-control" id="txtJumlahBPSK" readonly>
                      </div>
                    </div>
                  </div>
                </div>
